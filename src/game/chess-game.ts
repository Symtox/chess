...
export class ChessGame {
  ...
  constructor(canvas: HTMLCanvasElement) {
    ...
    const endGameDialogAdapter = new EndGameDialogAdapter(document.querySelector('dialog') as HTMLDialogElement, this.reset.bind(this))

    const whiteClockAdapter = new ClockAdapter(document.querySelector('clock-el[data-color="white"]') as Clock)
    const blackClockAdapter = new ClockAdapter(document.querySelector('clock-el[data-color="black"]') as Clock)
    ...
    this.sidebarController.listen(document.querySelector("aside") as HTMLElement)
