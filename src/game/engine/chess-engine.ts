...
import {Color, Coordinate, getOpponentColor, isCastle, isNormalMove, Move, NormalMove, Piece} from "@/types";
import {Grid} from "@/game/models/grid";

export class ChessEngine {
  constructor() {}

  computeAllowedMoves(piece: Piece, grid: Grid, pos: Coordinate, lastMove?: Move) {
